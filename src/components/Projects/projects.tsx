      ...
      <div className="container">
        <div className="flex flex-col mt-10 gap-20">
          {projectItems.map(project => (
            <div key={project.title} className="bg-card-bg-clr rounded-3xl z-0 overflow-hidden relative after:z-10 after:context-[''] after:absolute after:inset-0 after:outline after:outline-2 after:-outline-offset-2 after:rounded-3xl after:outline-white/20 px-8 md:px-10 lg:px-20 py-8 md:py-12 lg:py-16 mx-8 after:pointer-events-none">
              <div className="lg:grid lg:grid-cols-2 lg:gap-16">
                <div> 
                  ...
                  <h3 className="font-bold font-seri text-2xl md:text-4xl lg:text-5xl font-serif mt-2 md:mt-5 tracking-wide">
                    {project.title}
                  </h3>
